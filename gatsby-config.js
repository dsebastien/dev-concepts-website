  ...
  plugins: [
    ...
    // reference: https://www.gatsbyjs.com/plugins/gatsby-plugin-image
    {
      ...
      options: {
        ...
        // WARNING: Keep aligned with the breakpoints in Tailwind
        breakpoints: [600, 960, 1280, 1600, 1920, 2440],
      },
    },
    ...
    // FIXME uncomment once https://github.com/DeveloPassion/dev-concepts-website/issues/9 is resolved
    ...
    // Reference: https://www.gatsbyjs.com/plugins/gatsby-plugin-csp/
    {
      ...
      options: {
        ...
        directives: {
          ...
          "child-src": "'self'",
          "connect-src":
            "'self' http://localhost:8000 http://localhost:* ws://localhost:* plausible.io app.convertkit.com fonts.googleapis.com",
          "default-src": "'self'",
          "disown-opener": "",
