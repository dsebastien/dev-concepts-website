...
declare module '@tryghost/admin-api' {
  ...
  export interface GhostAdminApiOptions {
     ...
     */
    makeRequest?: (options: GhostAdminApiMakeRequestOptions) => Promise<unknown>;
    /**
  ...
  declare class GhostAdminApi implements GhostAdminApiInstance {
    ...
    posts: {
      ...
      edit: (data: Record<unknown>, queryParams: Record<unknown> = {}) => Promise<GhostPostUpdateResponse>;
