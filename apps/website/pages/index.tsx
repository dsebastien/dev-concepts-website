  ...
  return (
    <Layout>
      <StyledDiv className="large-page-content-wrapper space-y-32">
        ...
        <div id="core-agitation" className="grid grid-cols-1 place-items-center flex flow-col items-center justify-around">
          <div className="homepage-elevated-box px-24">
            ...
            <div className="mt-6 max-w-4xl mx-auto prose dark:prose-dark prose-lg">
              ...
              <p>
                Fact is, it's exhausting and demotivating trying to understand what you just don't know. You wind up feeling plain dumb with
                a growing mindset that it's just impossible
              </p>
          ...
          <div className="solution-focus-details">
            ...
            <div className="mt-6 prose dark:prose-dark prose-lg">
              <div className="flex flex-row items-center gap-2">
                ...
                <div className="flex flex-row items-center">
                  <span className="">Know that you're choosing the best solution even when there are countless approaches.</span>
                </div>
              </div>
              ...
              <div className="flex flex-row items-center gap-2">
                ...
                <div className="flex flex-row items-center">
                  <span className="">Understand the entire development process so you don't make project-destroying mistakes.</span>
                </div>
              </div>
              ...
              <div className="mt-2 flex flex-row items-center gap-2">
                ...
                <div className="flex flex-row items-center">
                  <span className="">Level up your game so team members, clients, and managers listen to your ideas.</span>
                </div>
              </div>
          ...
          <div className="min-w-full">
            <div className="flex flex-row justify-center">
              <h3 className="max-w-xl text-center">
                Each volume is packed full of detailed definitions, pros/cons, tips, and real-world lessons
              </h3>
            </div>
              ...
              <a href={volume01.gumroadShortUrl} rel="noopener">
                <div className="homepage-elevated-box-on-hover book-card">
                  ...
                  <footer>
                    ...
                    <div className="book-card-buy-now-text">
                      <span className="text-xl word-wrap font-semibold text-center">Buy: {volume01.price}</span>
                    </div>
                  </footer>
                </div>
              </a>
              <a href={volume02.gumroadShortUrl} rel="noopener">
                <div className="homepage-elevated-box-on-hover book-card">
                  ...
                  <footer>
                    ...
                    <div className="book-card-buy-now-text">
                      <span className="text-xl word-wrap font-semibold text-center">Buy: {volume02.price}</span>
                    </div>
                  </footer>
                </div>
              </a>
          ...
          <div className="solution-mentorship-details">
            ...
            <div className="mt-6 prose dark:prose-dark prose-lg">
              ...
              <div className="mt-2 flex flex-row items-center gap-2">
                ...
                <div className="flex flex-row items-center">
                  <span className="">Experienced developers will answer your questions directly.</span>
                </div>
              </div>
              ...
              <div className="mt-2 flex flex-row items-center gap-2">
                ...
                <div className="flex flex-row items-center">
                  <span className="">Get career guidance for practical problem solving and soft skills.</span>
                </div>
              </div>
              ...
              <div className="mt-2 flex flex-row items-center gap-2">
                ...
                <div className="flex flex-row items-center">
                  <span className="">Engage with the community to build friendships and connections with like-minded developers.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="social-proof" className="author grid grid-cols-1 md:grid-cols-2 gap-8 place-items-center">
          ...
          <div className="social-proof-author-details">
            ...
            <div className="mt-6 prose dark:prose-dark prose-lg space-y-2">
              ...
              <p>
                Daily, I help junior developers who often find themselves overwhelmed with a churn of programming languages, frameworks,
                libraries and tools.
              </p>
              <p>
                That’s why I created the Dev Concepts collection; to help even more developers avoid feeling overwhelmed, and show you where
                to apply your focus for maximum productivity and efficiency. The skills and habits from each volume form the foundation of
                your long-term success.
              </p>
              <p>
                Join a community of software crafters who, like you, are passionate about software, personal productivity, and career
                advancement.
              </p>
            </div>
          </div>
        ...
        <div id="social-proof-quote" className="grid grid-cols-1 place-items-center">
          <div className="max-w-2xl">
            <span className="italic text-3xl">
              “I love this job, I’m doing exactly what I want, my coworkers are smart and helpful, the pay is good, and the work-life
        ...
        <div id="faq" className="grid grid-cols-1 place-items-center">
          {' '}
          {/* homepage-elevated-box */}
          <div className="min-w-full">
            <div className="flex flex-row items-center justify-center">
            ...
            <div className="mt-12 mx-auto grid grid-cols-1 md:grid-cols-1 gap-x-12 gap-y-4 max-w-4xl">
              ...
              <details className="px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-700 cursor-pointer">
                ...
                <span className="prose dark:prose-dark prose-lg dark:text-devConceptsWhite">
                  ...
                  or by{' '}
                  <a href="mailto:sebastien@developassion.be" rel="noopener">
                    mail
                  </a>
                  ...
                  <ul className="space-y-4 ">
                    <li className="prose dark:prose-dark prose-lg">
                      ...
                      <div>
                        ...
                        architecture & OS basics, Coding Basics, General concerns & Best practices, Back-end, Front-end, IT Infrastructure,
