...
const NewsletterSubscribe = () => {
  ...
  return (
    <div className="dark:bg-devConceptsGray-800 border-2 border-devConceptsGray-300 dark:border-devConceptsGray-800 hover:border-devConceptsBlue-400 dark:hover:border-devConceptsBlue-400 w-2/3 p-4 rounded-md transform hover:shadow-lg dark:hover:opacity-90 transition-all duration-150 ease-in">
      <div className="flex flex-col items-center justify-center mb-4">
        <div className="text-6xl text-devConceptsPink-400 mb-2">
          ...
          {form.state === 'ready' ? (
            <>
              <div className="text-center">
                <span>Subscribe to DeveloPassion's newsletter</span>
              </div>
              <div className="text-center">
